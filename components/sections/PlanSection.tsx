...
/**
 * Plans Section
 * Displays plan cards with tablet mockup and parallax background
 */
              ...
              return (
                <motion.div
                  ...
                  className={`bg-white rounded-3xl p-8 md:p-9 flex flex-col transition-all duration-400 hover:-translate-y-1 ${
                    plan.highlighted
                      ? 'shadow-[0_20px_60px_rgba(0,0,0,0.2)] ring-2 ring-white/30 scale-[1.02] md:scale-105 relative'
                      : 'shadow-lg'
                  }`}
                >
                  ...
                  {plan.highlighted && (
                    <>
                      <div className="absolute -inset-px rounded-3xl bg-gradient-to-br from-gold-primary/30 via-gold-signature/20 to-gold-light/30 -z-10 blur-sm" />
